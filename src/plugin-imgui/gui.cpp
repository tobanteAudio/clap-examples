...
bool Plugin::createUI(const char *api, bool is_floating) {
...
bool Plugin::setTransient(const clap_window *window) { return false; }

void Plugin::suggestTitle(const char *title) {}
