...
struct Plugin {
  ...
  virtual bool plugin_impl__activate(double sample_rate,
  ...
  virtual clap_process_status
  plugin_impl__process(const clap_process *process) = 0;
  ...
  virtual bool plugin_impl__get_preferred_size(uint32_t *width,
                                               uint32_t *height) = 0;
  ...
  virtual bool params__get_info(uint32_t param_index,
                                clap_param_info_t *param_info) = 0;
  virtual bool params__get_value(clap_id param_id, double *value) = 0;
  virtual bool params__value_to_text(clap_id param_id, double value,
                                     char *display, uint32_t size) = 0;
  virtual bool params__text_to_value(clap_id param_id, const char *display,
                                     double *value) = 0;
  virtual void params__flush(const clap_input_events *in,
