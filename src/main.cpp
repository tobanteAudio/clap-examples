...
void render_conan_logo() {
  ...
  draw_list->AddQuadFilled(
      ImVec2(x, y + 0.25F * sz), ImVec2(x + 0.5F * sz, y + 0.5F * sz),
      ImVec2(x + sz, y + 0.25F * sz), ImVec2(x + 0.5F * sz, y), ImColor(col1));
  draw_list->AddQuadFilled(ImVec2(x, y + 0.25F * sz),
                           ImVec2(x + 0.5F * sz, y + 0.5F * sz),
                           ImVec2(x + 0.5F * sz, y + 1.0F * sz),
                           ImVec2(x, y + 0.75F * sz), ImColor(col2));
  draw_list->AddQuadFilled(ImVec2(x + 0.5F * sz, y + 0.5F * sz),
                           ImVec2(x + sz, y + 0.25F * sz),
                           ImVec2(x + sz, y + 0.75F * sz),
                           ImVec2(x + 0.5F * sz, y + 1.0F * sz), ImColor(col3));
  draw_list->AddLine(ImVec2(x + 0.75F * sz, y + 0.375F * sz),
                     ImVec2(x + 0.75F * sz, y + 0.875F * sz), ImColor(col4));
  draw_list->AddBezierCubic(ImVec2(x + 0.72F * sz, y + 0.24F * sz),
                            ImVec2(x + 0.68F * sz, y + 0.15F * sz),
                            ImVec2(x + 0.48F * sz, y + 0.13F * sz),
                            ImVec2(x + 0.39F * sz, y + 0.17F * sz),
                            ImColor(col4), 10, 18);
  draw_list->AddBezierCubic(ImVec2(x + 0.39F * sz, y + 0.17F * sz),
